...
from flask_sqlalchemy import SQLAlchemy
                                           # a Flask-friendly wrapper to the popular SQLAlchemy package, which is an Object Relational Mapper or ORM.
                                           # ORMs allow applications to manage a database using high-level entities
                                           # such as classes, objects and methods instead of tables and SQL.
...
mail = Mail(app)
db = SQLAlchemy(app) #The database is going to be represented in the application by the database instance.
migrate = Migrate(app, db) #The database migration engine will also have an instance.
